...
import { Heart, Coins, Pause, Timer, Zap, Sparkles } from 'lucide-react';
...
export const GameHUD: React.FC = () => {
  ...
  return (
    <div className="absolute top-0 left-0 right-0 z-30 p-4 pointer-events-none flex items-start justify-between">
      {/* Top Left Stats & Game Title */}
      <div className="flex flex-col items-start gap-2">
        {/* Title Badge */}
        <div className="pointer-events-auto flex items-center gap-1.5 px-3 py-1 rounded-xl bg-amber-500/20 border border-amber-400/40 backdrop-blur-md">
          <Sparkles className="w-3.5 h-3.5 text-amber-400" />
          <span className="font-pixel text-[10px] text-amber-300 tracking-wider">AMINE JHILEL</span>
        </div>
